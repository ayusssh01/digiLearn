...
import ayush from "../../src/assets/LinkedIn/ayush.jpg";
import priya from "../../src/assets/LinkedIn/priya.jpg";
...
export default function TopHome() {
  ...
  const img = [
  {
      ...
      "linkedin" : "https://www.linkedin.com/in/ranachandansingh/",
      "hover" : isHovered3
    },
    {
      "src" : priya , 
      ...
      "linkedin" : "https://www.linkedin.com/in/priya998/",
      "hover" : isHovered2
    },
    {
      "src" : ayush , 
      ...
      "linkedin" : "https://www.linkedin.com/in/ayush-jha-755280190/",
      "hover" : isHovered1
    },
  ];
  return (
    <div className="text-white flex flex-col w-full h-[100vh] relative">
        ...
        <div className="flex flex-col w-full lg:max-w-[790px] text-center justify-center  mx-auto my-auto gap-4">
          ...
          >
            <div className="flex gap-2 text-center sm:flex-col sm:gap-5 md:flex-row">
              {" "}
              WELCOME TO
              <HighlightedText text={"DigiLearn"} />
            </div>
          </motion.p>
          <motion.h1
      ...
      <div className="text-end text-sm text-richblack-200 font-edu-sa">
        <p className="p-2">Developed by Ayush Jha © 2025 DigiLearn</p>
      </div>
    </div>
  );
}
